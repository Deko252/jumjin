    ...
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" action="./join.do" method="post" novalidate>
          ...
          <div class="mb-3">
            <label for="password" style="font-weight: bold; font-size: 20px;">현재 비밀번호</label>
          ...
          <div class="mb-3">
            <label for="password" style="font-weight: bold; font-size: 20px;">새 비밀번호</label>
            <input type="password" class="form-control" id="pw" name="pw" placeholder="6자리 이상 입력해주세요." required>
            <div class="invalid-feedback">
              비밀번호를 입력해주세요.
            </div>
          ...
          <div class="mb-3">
            <label for="password" style="font-weight: bold; font-size: 20px;">새 비밀번호 확인</label>
